    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-white">
            ...
            <p className="text-sm py-4 text-gray-800">
                "Building my resume with this platform was effortless. made my resume stand out instantly!"
            </p>
        </div>
    );
        ...
        <>
            <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
                ...
                <Title
                    ...
                    description="Thousands of professionals trust our Resume Builder to create stunning, job-winning resumes effortlessly. Here's what a few of them had to say."
                />
            </div>
